...
{
	public static final ModelLayerLocation CASTLE_LORD_MODEL_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Ceilands.MOD_ID, "castle_lord"), "main");
	public static final ModelLayerLocation CASTLE_LORD_MODEL_OUTER_ARMOR_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Ceilands.MOD_ID, "castle_lord"), "outer_armor");
	public static final ModelLayerLocation CASTLE_LORD_MODEL_INNER_ARMOR_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Ceilands.MOD_ID, "castle_lord"), "inner_armor");
	...
	public ResourceLocation getTextureLocation(CastleLord mob) {
		return ResourceLocation.fromNamespaceAndPath(Ceilands.MOD_ID, "textures/entity/castle_lord/castle_lord.png");
	}
