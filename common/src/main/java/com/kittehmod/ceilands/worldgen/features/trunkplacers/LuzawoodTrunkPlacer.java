...
{
	public static final MapCodec<LuzawoodTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec((func) -> { return trunkPlacerParts(func).apply(func, LuzawoodTrunkPlacer::new); });
