...
{
	public static final MapCodec<DoubleLuzawoodTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec((func) -> { return trunkPlacerParts(func).apply(func, DoubleLuzawoodTrunkPlacer::new); });
