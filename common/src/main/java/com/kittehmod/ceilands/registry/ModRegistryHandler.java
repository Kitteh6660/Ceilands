...
public class ModRegistryHandler 
{
	...
	public static void registerBlocks() {
		...
		addToRegisterable(BLOCKS, new ResourceLocation(Ceilands.MOD_ID, "ceiltrunk_hanging_sign"), CeilandsBlocks.CEILTRUNK_HANGING_SIGN);
		addToRegisterable(BLOCKS, new ResourceLocation(Ceilands.MOD_ID, "ceiltrunk_wall_hanging_sign"), CeilandsBlocks.CEILTRUNK_WALL_HANGING_SIGN);
		...
		addToRegisterable(BLOCKS, new ResourceLocation(Ceilands.MOD_ID, "luzawood_hanging_sign"), CeilandsBlocks.LUZAWOOD_HANGING_SIGN);
		addToRegisterable(BLOCKS, new ResourceLocation(Ceilands.MOD_ID, "luzawood_wall_hanging_sign"), CeilandsBlocks.LUZAWOOD_WALL_HANGING_SIGN);
	...
	public static void registerItems() {
		...
		addToRegisterable(ITEMS, new ResourceLocation(Ceilands.MOD_ID, "ceiltrunk_hanging_sign"), CeilandsItems.CEILTRUNK_HANGING_SIGN);
		...
		addToRegisterable(ITEMS, new ResourceLocation(Ceilands.MOD_ID, "luzawood_hanging_sign"), CeilandsItems.LUZAWOOD_HANGING_SIGN);
