...
public class TwilightForestCompat 
{
	...
	public TwilightForestCompat(boolean register) {
		...
		HollowLogHorizontal HOLLOW_CEILTRUNK_LOG_HORIZONTAL = new HollowLogHorizontal(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0F, 4.0F).sound(SoundType.WOOD));
		HollowLogVertical HOLLOW_CEILTRUNK_LOG_VERTICAL = new HollowLogVertical(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0F, 4.0F).sound(SoundType.WOOD), HOLLOW_CEILTRUNK_LOG_CLIMBABLE_RO);
		HollowLogClimbable HOLLOW_CEILTRUNK_LOG_CLIMBABLE = new HollowLogClimbable(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0F, 4.0F).sound(SoundType.WOOD), HOLLOW_CEILTRUNK_LOG_VERTICAL_RO);
		HollowLogHorizontal HOLLOW_LUZAWOOD_LOG_HORIZONTAL = new HollowLogHorizontal(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0F, 4.0F).sound(SoundType.WOOD));
		HollowLogVertical HOLLOW_LUZAWOOD_LOG_VERTICAL = new HollowLogVertical(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0F, 4.0F).sound(SoundType.WOOD), HOLLOW_LUZAWOOD_LOG_CLIMBABLE_RO);
		HollowLogClimbable HOLLOW_LUZAWOOD_LOG_CLIMBABLE = new HollowLogClimbable(Block.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0F, 4.0F).sound(SoundType.WOOD), HOLLOW_LUZAWOOD_LOG_VERTICAL_RO);
		...
		CeilandsRegistry.COMPAT_ITEMS.add(new Pair(CEILTRUNK_HOLLOW_LOG_RES, new CeilandsHollowLogItem(() -> HOLLOW_CEILTRUNK_LOG_HORIZONTAL, () -> HOLLOW_CEILTRUNK_LOG_VERTICAL, () -> HOLLOW_CEILTRUNK_LOG_CLIMBABLE, new Item.Properties())));
		CeilandsRegistry.COMPAT_ITEMS.add(new Pair(LUZAWOOD_HOLLOW_LOG_RES, new CeilandsHollowLogItem(() -> HOLLOW_LUZAWOOD_LOG_HORIZONTAL, () -> HOLLOW_LUZAWOOD_LOG_VERTICAL, () -> HOLLOW_LUZAWOOD_LOG_CLIMBABLE, new Item.Properties())));
	...
	public void assignItemsToTabs(BuildCreativeModeTabContentsEvent event) {
		...
		if (event.getTabKey() == TFCreativeTabs.BLOCKS.getKey()) {
			map.putAfter(TFBlocks.CHERRY_BANISTER.get().asItem().getDefaultInstance(), ForgeRegistries.ITEMS.getValue(CEILTRUNK_BANISTER_RES).getDefaultInstance(), TabVisibility.PARENT_AND_SEARCH_TABS);
			map.putAfter(ForgeRegistries.ITEMS.getValue(CEILTRUNK_BANISTER_RES).getDefaultInstance(), ForgeRegistries.ITEMS.getValue(LUZAWOOD_BANISTER_RES).getDefaultInstance(), TabVisibility.PARENT_AND_SEARCH_TABS);
			map.putAfter(TFItems.HOLLOW_CHERRY_LOG.get().asItem().getDefaultInstance(), ForgeRegistries.ITEMS.getValue(CEILTRUNK_HOLLOW_LOG_RES).getDefaultInstance(), TabVisibility.PARENT_AND_SEARCH_TABS);
			map.putAfter(ForgeRegistries.ITEMS.getValue(CEILTRUNK_HOLLOW_LOG_RES).getDefaultInstance(), ForgeRegistries.ITEMS.getValue(LUZAWOOD_HOLLOW_LOG_RES).getDefaultInstance(), TabVisibility.PARENT_AND_SEARCH_TABS);
		}
	}
}
