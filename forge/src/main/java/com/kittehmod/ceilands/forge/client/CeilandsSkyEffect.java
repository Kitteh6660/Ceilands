...
public class CeilandsSkyEffect implements IForgeDimensionSpecialEffects
{
	...
	public static class CeilandsEffects extends DimensionSpecialEffects
	{
		...
		@Override
		public boolean renderSky(ClientLevel level, int ticks, float partialTick, PoseStack poseStack, Camera camera, Matrix4f projectionMatrix, boolean isFoggy, Runnable runnable) {
			runnable.run();
