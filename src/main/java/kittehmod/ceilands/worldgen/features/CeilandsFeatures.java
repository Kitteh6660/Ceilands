...
public class CeilandsFeatures
{
	...
	public static final RegistryObject<Feature<BlockStateConfiguration>> CEILING_MOSS_PATCH = FEATURES.register("ceiling_moss_patch", () -> new CeilingMossPatchFeature(BlockStateConfiguration.CODEC));
